  ...
  return (
    <main className="page-container">
      ...
      <style>{`
        ...
        .card { padding: 32px; border-radius: var(--radius-lg); background: var(--bg-card); border: 1px solid var(--glass-border); }
        ...
        .model-card { background: var(--bg-card); border: 1px solid var(--glass-border); border-radius: var(--radius-md); display: flex; flex-direction: column; transition: all 0.2s cubic-bezier(0.4,0,0.2,1); overflow: hidden; position: relative; }
        .model-card:hover { border-color: var(--text-muted); transform: translateY(-4px); box-shadow: 0 12px 24px -12px rgba(0,0,0,0.2); }
        .model-card.is-active { border-color: #2ea043; background: linear-gradient(135deg, var(--bg-card), rgba(46,160,67,0.03)); }
        ...
        .status-badge.active { color: #2ea043; }
        .status-badge.inactive { color: var(--text-muted); }
        .dot { width: 6px; height: 6px; border-radius: 50%; background: #2ea043; box-shadow: 0 0 8px #2ea043; }
        ...
        .primary-ghost:hover:not(.disabled) { background: #2ea043; color: white; border-color: #2ea043; }
        .model-card.is-active .primary-ghost.disabled { color: #2ea043; font-weight: 700; border-color: transparent; cursor: default; }
        ...
        .setup-hint { margin-top: 16px !important; color: #f59e0b !important; font-size: 13px !important; }
        ...
        .approval-controls select { height: 40px; padding: 0 12px; background: var(--bg-base); border: 1px solid var(--glass-border); border-radius: 8px; color: var(--text-primary); font-family: inherit; font-size: 14px; }
        ...
        .approval-mode-hint .danger-hint { color: #ef4444; font-weight: 500; }
