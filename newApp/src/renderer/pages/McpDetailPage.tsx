  ...
  return (
    <main data-testid="mcp-detail-view" className="page-container">
      ...
      <style>{`
        ...
        .risk-badge[data-risk="low"] { color: #22c55e; border-color: rgba(34,197,94,0.25); background: rgba(34,197,94,0.08); }
        .risk-badge[data-risk="medium"] { color: #f59e0b; border-color: rgba(245,158,11,0.25); background: rgba(245,158,11,0.08); }
        .risk-badge[data-risk="high"] { color: #ef4444; border-color: rgba(239,68,68,0.25); background: rgba(239,68,68,0.08); }
        ...
        .form-error { margin: 0; color: #f87171; font-size: 13px; }
