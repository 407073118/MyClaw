  ...
  return (
    <main className="page-container tools-view">
      ...
      <style>{`
        ...
        .group-card { padding: 32px; border-radius: var(--radius-xl); background: var(--bg-card); border: 1px solid var(--glass-border); margin-bottom: 16px; backdrop-filter: var(--blur-std); -webkit-backdrop-filter: var(--blur-std); box-shadow: var(--shadow-card), var(--glass-inner-glow); }
        ...
        .tool-item { display: grid; grid-template-columns: minmax(0, 1fr) auto; gap: 20px; padding: 20px; border-radius: var(--radius-lg); background: var(--bg-base); border: 1px solid var(--glass-border); backdrop-filter: var(--blur-std); -webkit-backdrop-filter: var(--blur-std); box-shadow: 0 1px 4px rgba(0,0,0,0.15), var(--glass-inner-glow); transition: border-color 0.25s ease, box-shadow 0.25s ease, transform 0.25s ease; }
        .tool-item:hover { border-color: var(--glass-border-hover); box-shadow: var(--shadow-card), var(--glass-inner-glow); transform: translateY(-1px); }
