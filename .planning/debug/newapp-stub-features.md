...
trigger: "newApp has many stub/fake features - chat doesn't work, model test is fake, need comprehensive audit and fix"
...
hypothesis: Most features in newApp are stubs returning fake data without real backend calls
