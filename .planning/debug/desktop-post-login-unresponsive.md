...
trigger: "After login succeeds in desktop, clicking anything has no response"
...
reproduction: npm run build && npm start in F:/MyClaw/desktop
...
files_changed: [F:/MyClaw/desktop/src/renderer/layouts/AppShell.tsx]
