...
trigger: "desktop login fails with cloud_api_request_failed despite cloud-api running at localhost:43210"
...
reproduction: npm run build:main && npm start in F:/MyClaw/desktop, then try to login
