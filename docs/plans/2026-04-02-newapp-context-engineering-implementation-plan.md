...
**Goal:** Upgrade `newApp` into a context-engineering system that can support arbitrary model sources, resolve real token limits dynamically, keep one chat window alive for long sessions, and add layered memory plus controlled compaction.
...
`newApp` already has basic context control, but it does not yet have a real context-engineering architecture:

- `newApp/shared/contracts/model.ts`
...
- `newApp/src/main/ipc/sessions.ts`
...
- `newApp/src/main/services/model-client.ts`
...
- `newApp/src/renderer/pages/ModelDetailPage.tsx`
...
**Files:**
- Modify: `newApp/shared/contracts/model.ts`
- Modify: `newApp/shared/contracts/session.ts`
- Modify: `newApp/shared/contracts/index.ts`
...
**Create:**
- `newApp/src/main/services/model-capability-registry.ts`
- `newApp/src/main/services/model-capability-resolver.ts`
- `newApp/src/main/services/provider-capability-probers/openai-compatible.ts`
- `newApp/src/main/services/provider-capability-probers/anthropic.ts`
- `newApp/src/main/services/provider-capability-probers/local-gateway.ts`
- `newApp/src/main/services/provider-capability-probers/openrouter.ts`
- `newApp/src/main/services/provider-capability-probers/vercel-ai-gateway.ts`
- `newApp/src/main/services/provider-capability-probers/ollama.ts`
...
**Create:**
- `newApp/src/main/services/token-estimator.ts`
- `newApp/src/main/services/token-budget-manager.ts`
...
**Create:**
- `newApp/src/main/services/context-assembler.ts`
- `newApp/src/main/services/context-compactor.ts`
- `newApp/src/main/services/context-checkpoint-service.ts`
- `newApp/src/main/services/tool-output-sanitizer.ts`
...
**Create:**
- `newApp/src/main/services/memory-service.ts`
- `newApp/src/main/services/memory-extractor.ts`
- `newApp/src/main/services/memory-retriever.ts`
- `newApp/src/main/services/memory-ranker.ts`
...
- `newApp/src/main/ipc/models.ts`
- `newApp/src/main/ipc/sessions.ts`
- `newApp/src/main/ipc/bootstrap.ts`
- `newApp/src/preload/index.ts`
- `newApp/src/renderer/types/electron.d.ts`
- `newApp/src/renderer/stores/workspace.ts`
- `newApp/src/renderer/pages/ModelDetailPage.tsx`
- `newApp/src/renderer/pages/ModelsPage.tsx`
- `newApp/src/renderer/pages/SettingsPage.tsx`
- `newApp/src/renderer/pages/ChatPage.tsx`
...
- Modify: `newApp/shared/contracts/session.ts`
- Modify: `newApp/shared/contracts/index.ts`
- Modify: `newApp/src/renderer/types/electron.d.ts`
- Test: `newApp/tests/phase9-model-capability-contracts.test.ts`
...
```powershell
pnpm --dir newApp exec vitest run tests/phase9-model-capability-contracts.test.ts
```
...
```powershell
pnpm --dir newApp exec vitest run tests/phase9-model-capability-contracts.test.ts tests/phase6-smart-compact.test.ts
```

**Step 5: Commit**

```bash
git add newApp/shared/contracts newApp/src/renderer/types/electron.d.ts newApp/tests/phase9-model-capability-contracts.test.ts
...
**Files:**
- Create: `newApp/src/main/services/model-capability-registry.ts`
- Create: `newApp/src/main/services/model-capability-resolver.ts`
- Modify: `newApp/src/main/services/runtime-context.ts`
- Modify: `newApp/src/main/services/state-persistence.ts`
- Test: `newApp/tests/phase10-model-capability-resolver.test.ts`
...
```powershell
pnpm --dir newApp exec vitest run tests/phase10-model-capability-resolver.test.ts
```
...
```bash
git add newApp/src/main/services/model-capability-registry.ts newApp/src/main/services/model-capability-resolver.ts newApp/src/main/services/runtime-context.ts newApp/src/main/services/state-persistence.ts newApp/tests/phase10-model-capability-resolver.test.ts
...
**Files:**
- Create: `newApp/src/main/services/provider-capability-probers/openai-compatible.ts`
- Create: `newApp/src/main/services/provider-capability-probers/anthropic.ts`
- Create: `newApp/src/main/services/provider-capability-probers/local-gateway.ts`
- Create: `newApp/src/main/services/provider-capability-probers/openrouter.ts`
- Create: `newApp/src/main/services/provider-capability-probers/vercel-ai-gateway.ts`
- Create: `newApp/src/main/services/provider-capability-probers/ollama.ts`
- Modify: `newApp/src/main/ipc/models.ts`
- Modify: `newApp/src/preload/index.ts`
- Modify: `newApp/src/renderer/stores/workspace.ts`
- Modify: `newApp/src/renderer/types/electron.d.ts`
- Test: `newApp/tests/phase11-provider-capability-probers.test.ts`
...
```powershell
pnpm --dir newApp exec vitest run tests/phase11-provider-capability-probers.test.ts
```
...
```bash
git add newApp/src/main/services/provider-capability-probers newApp/src/main/ipc/models.ts newApp/src/preload/index.ts newApp/src/renderer/stores/workspace.ts newApp/src/renderer/types/electron.d.ts newApp/tests/phase11-provider-capability-probers.test.ts
...
**Files:**
- Create: `newApp/src/main/services/token-estimator.ts`
- Create: `newApp/src/main/services/token-budget-manager.ts`
- Modify: `newApp/src/main/services/model-client.ts`
- Test: `newApp/tests/phase12-token-budget-manager.test.ts`
...
```powershell
pnpm --dir newApp exec vitest run tests/phase12-token-budget-manager.test.ts
```
...
```powershell
pnpm --dir newApp exec vitest run tests/phase12-token-budget-manager.test.ts tests/phase6-smart-compact.test.ts
```

**Step 5: Commit**

```bash
git add newApp/src/main/services/token-estimator.ts newApp/src/main/services/token-budget-manager.ts newApp/src/main/services/model-client.ts newApp/tests/phase12-token-budget-manager.test.ts
...
**Files:**
- Create: `newApp/src/main/services/context-assembler.ts`
- Create: `newApp/src/main/services/context-compactor.ts`
- Create: `newApp/src/main/services/context-checkpoint-service.ts`
- Create: `newApp/src/main/services/tool-output-sanitizer.ts`
- Modify: `newApp/src/main/ipc/sessions.ts`
- Test: `newApp/tests/phase13-context-assembly.test.ts`
...
```powershell
pnpm --dir newApp exec vitest run tests/phase13-context-assembly.test.ts
```
...
```powershell
pnpm --dir newApp exec vitest run tests/phase13-context-assembly.test.ts tests/phase6-smart-compact.test.ts
```

**Step 5: Commit**

```bash
git add newApp/src/main/services/context-assembler.ts newApp/src/main/services/context-compactor.ts newApp/src/main/services/context-checkpoint-service.ts newApp/src/main/services/tool-output-sanitizer.ts newApp/src/main/ipc/sessions.ts newApp/tests/phase13-context-assembly.test.ts
...
**Files:**
- Create: `newApp/src/main/services/memory-service.ts`
- Create: `newApp/src/main/services/memory-extractor.ts`
- Create: `newApp/src/main/services/memory-retriever.ts`
- Create: `newApp/src/main/services/memory-ranker.ts`
- Modify: `newApp/src/main/services/state-persistence.ts`
- Modify: `newApp/src/main/ipc/bootstrap.ts`
- Modify: `newApp/src/main/ipc/sessions.ts`
- Test: `newApp/tests/phase14-memory-service.test.ts`
...
```powershell
pnpm --dir newApp exec vitest run tests/phase14-memory-service.test.ts
```
...
```powershell
pnpm --dir newApp exec vitest run tests/phase14-memory-service.test.ts tests/phase13-context-assembly.test.ts
```

**Step 5: Commit**

```bash
git add newApp/src/main/services/memory-service.ts newApp/src/main/services/memory-extractor.ts newApp/src/main/services/memory-retriever.ts newApp/src/main/services/memory-ranker.ts newApp/src/main/services/state-persistence.ts newApp/src/main/ipc/bootstrap.ts newApp/src/main/ipc/sessions.ts newApp/tests/phase14-memory-service.test.ts
...
- Modify: `newApp/src/renderer/types/electron.d.ts`
- Modify: `newApp/src/renderer/stores/workspace.ts`
- Modify: `newApp/src/renderer/pages/ModelDetailPage.tsx`
- Modify: `newApp/src/renderer/pages/ModelsPage.tsx`
- Modify: `newApp/src/renderer/pages/SettingsPage.tsx`
- Modify: `newApp/src/renderer/pages/ChatPage.tsx`
- Test: `newApp/tests/phase15-context-ui.test.tsx`
...
```powershell
pnpm --dir newApp exec vitest run tests/phase15-context-ui.test.tsx
```
...
```bash
git add newApp/src/preload/index.ts newApp/src/renderer/types/electron.d.ts newApp/src/renderer/stores/workspace.ts newApp/src/renderer/pages/ModelDetailPage.tsx newApp/src/renderer/pages/ModelsPage.tsx newApp/src/renderer/pages/SettingsPage.tsx newApp/src/renderer/pages/ChatPage.tsx newApp/tests/phase15-context-ui.test.tsx
...
- Modify: `newApp/src/main/ipc/models.ts`
- Modify: `newApp/src/main/ipc/sessions.ts`
- Modify: `newApp/src/main/services/logger.ts` if present, otherwise create it
- Modify: `newApp/vitest.config.ts`
- Test: `newApp/tests/phase16-context-fallbacks.test.ts`
...
```powershell
pnpm --dir newApp exec vitest run tests/phase16-context-fallbacks.test.ts
```
...
```powershell
pnpm --dir newApp test
pnpm --dir newApp typecheck
pnpm --dir newApp build
```
...
rg -n $pattern newApp docs/plans/2026-04-02-newapp-context-engineering-implementation-plan.md
```

**Step 6: Commit**

```bash
git add newApp docs/plans/2026-04-02-newapp-context-engineering-implementation-plan.md
...
After implementation, `newApp` should be able to:
...
- Do not let multiple workers modify `newApp/src/main/ipc/sessions.ts` at the same time.
- `newApp/shared/contracts/model.ts` and `newApp/shared/contracts/session.ts` are protocol-critical and must be reviewed last across all consumers.
