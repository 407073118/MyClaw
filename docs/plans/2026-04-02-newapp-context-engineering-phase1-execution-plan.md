...
**Goal:** Deliver the Phase 1 foundation for `newApp` context engineering by expanding contracts, adding a model capability resolver, and upgrading model catalog flows to return normalized capability metadata.
...
- `newApp/shared/contracts/index.ts`
- `newApp/src/renderer/types/electron.d.ts`
- `newApp/src/main/services/runtime-context.ts`
- `newApp/src/main/services/state-persistence.ts`
...
- `newApp/tests/phase9-model-capability-contracts.test.ts`
- `newApp/tests/phase10-model-capability-resolver.test.ts`
- `newApp/tests/phase11-provider-capability-probers.test.ts`
...
Create `newApp/tests/phase9-model-capability-contracts.test.ts` with checks for:
...
Add the new exported types and fields in `newApp/shared/contracts/model.ts`.
...
Check `newApp/shared/contracts/index.ts`.
...
```bash
git add newApp/shared/contracts/model.ts newApp/shared/contracts/index.ts newApp/src/renderer/types/electron.d.ts newApp/tests/phase9-model-capability-contracts.test.ts
...
Create `newApp/tests/phase10-model-capability-resolver.test.ts`.
...
Create `newApp/tests/phase11-provider-capability-probers.test.ts`.
...
```powershell
pnpm --dir newApp exec vitest run tests/phase11-provider-capability-probers.test.ts
pnpm --dir newApp exec vitest run tests/phase9-model-capability-contracts.test.ts tests/phase10-model-capability-resolver.test.ts tests/phase11-provider-capability-probers.test.ts
```
...
```bash
git add newApp/src/main/services/provider-capability-probers newApp/src/main/ipc/models.ts newApp/src/preload/index.ts newApp/src/renderer/stores/workspace.ts newApp/src/renderer/types/electron.d.ts newApp/src/renderer/pages/ModelDetailPage.tsx newApp/tests/phase11-provider-capability-probers.test.ts
